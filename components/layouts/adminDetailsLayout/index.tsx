        ...
        >
          <Box sx={{ mb: 4, display: "flex", alignItems: "center", gap: 2 }}>
            ...
            <Box>
              <Typography
                variant="h4"
                fontWeight={800}
                sx={{ ...commonStyles, letterSpacing: "-0.5px" }}
              >
                Admin Information
              </Typography>
              <Typography
          ...
          {detailsLoading ? (
            ...
            <Paper sx={{ p: 4, textAlign: "center", borderRadius: "15px" }}>
              <Typography color="error" variant="h6" sx={commonStyles}>
                {error}
              </Typography>
              <Button
                variant="contained"
                onClick={() => window.location.reload()}
                sx={{ mt: 2, bgcolor: COLORS.ACCENT }}
              >
                Retry
              </Button>
            </Paper>
            ...
            >
              ...
              <Stack spacing={3}>
                ...
                >
                  ...
                  <Stack alignItems="center" spacing={2} sx={{ pt: 2 }}>
                    ...
                    >
                      {(
                        selectedAdminDetails.firstName?.[0] ||
                        selectedAdminDetails.name?.[0] ||
                        "A"
                      ).toUpperCase()}
                    </Box>
                    <Box textAlign="center">
                      ...
                      >
                        {selectedAdminDetails.name ||
                          `${selectedAdminDetails.firstName} ${selectedAdminDetails.lastName}`}
                      </Typography>
                      <Chip
                  ...
                  <Stack spacing={2.5} sx={{ mt: 4 }}>
                    <Box>
                      ...
                      <Typography
                        variant="body1"
                        sx={{ ...commonStyles, fontWeight: 500, mt: 0.5 }}
                      >
                    ...
                    >
                      ...
                      <Typography
                        variant="body2"
                        sx={{ ...commonStyles, fontWeight: 500 }}
                      >
              ...
              <Box>
                ...
                >
                  ...
                  {selectedAdminDetails.crewMembers &&
                  selectedAdminDetails.crewMembers.length > 0 ? (
                    <Box
                      sx={{
                        display: "grid",
